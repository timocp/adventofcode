...
fn run(year: usize, day: usize) {
    ...
    if let Ok(input) = read_file(&filename) {
        match (year, day) {
            ...
            (2019, 12) => solve::<y2019::day12::Solver>(year, day, &input),
            (2019, 13) => solve::<y2019::day13::Solver>(year, day, &input),
            (2019, 14) => solve::<y2019::day14::Solver>(year, day, &input),
            (2019, 15) => solve::<y2019::day15::Solver>(year, day, &input),
            (2019, 16) => solve::<y2019::day16::Solver>(year, day, &input),
            (2019, 17) => solve::<y2019::day17::Solver>(year, day, &input),
            (2019, 18) => solve::<y2019::day18::Solver>(year, day, &input),
            (2019, 19) => solve::<y2019::day19::Solver>(year, day, &input),
            (2019, 20) => solve::<y2019::day20::Solver>(year, day, &input),
            (2019, 21) => solve::<y2019::day21::Solver>(year, day, &input),
            (2019, 22) => solve::<y2019::day22::Solver>(year, day, &input),
            (2019, 23) => solve::<y2019::day23::Solver>(year, day, &input),
            (2019, 24) => solve::<y2019::day24::Solver>(year, day, &input),
            (2019, 25) => solve::<y2019::day25::Solver>(year, day, &input),
            ...
            (2025, 2) => solve::<y2025::day2::Solver>(year, day, &input),
            (2025, 3) => solve::<y2025::day3::Solver>(year, day, &input),
            (2025, 4) => solve::<y2025::day4::Solver>(year, day, &input),
            (_, _) => {}
        }
    } else {
